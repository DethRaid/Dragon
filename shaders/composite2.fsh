...
#define SMOOTH_SKY			//Turn on when using 3D clouds/Volumetric clouds
...
#define NO_UNDERWATER_RAYS		//turn this on to remove Godrays from coming through the water, if on there could be bugs 
