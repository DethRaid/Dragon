                        ...
                        #define USE_RANDOM_ROTATION
                            ...
                            mat2 kernelRotation = mat2(
                                ...
                                for( int j = -PCFSizeHalf; j <= PCFSizeHalf; j++ ) {
                                                                ...
                                                                float shadowDepth = shadow2DLod(shadow, vec3(worldposition.st + sampleCoord, worldposition.z - 0.00018f * diffthresh), 0).r;
                                                                numBlockers +=  step(worldposition.z - shadowDepth, 0.00018f);
                                                                numSamples++;
